...
import (
	...
	"go_pratice_code/learn_ccmouse_code/crawler/model"
	"regexp"
	"strconv"
)

var ageRe = regexp.MustCompile(`<div class="m-btn purple" data-v-bff6f798="">([\d]+)岁</div>`)
var heightRe = regxp.MustCompile(`<div class="m-btn purple" data-v-bff6f798="">(\d+)cm</div>`)
...
// 没有性别字段
var genderRe = regex.MustCompile(``)
